...
// Tabbar
#define kTabBar_Main_Normal_Icon                 [UIImage imageNamed:@"icon_home00"]
#define kTabBar_Main_Select_Icon                 [UIImage imageNamed:@"icon_home01"]

#define kTabBar_Discovery_Normal_Icon            [UIImage imageNamed:@"icon_find00"]
#define kTabBar_Discovery_Select_Icon            [UIImage imageNamed:@"icon_find01"]
